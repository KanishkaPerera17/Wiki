...
<html>
	...
	<body>
		...
		<div class="content">
			...
			<c:forEach items="${HiddenArticles}" var="articles"> 
				<div class="article-container">
					<div class="article-box">
						...
						<span class="main-panel"><br />
							...
							<a onclick="deleteConfirmation('${pageContext.request.contextPath}/ArticleController?action=auth_delete_article&id=${articles.getAid()}&path=auth_hidden_articles')">Delete</a>  | 
							<a href="${pageContext.request.contextPath}/ArticleController?action=auth_show_hide&id=${articles.getAid()}&path=auth_hidden_articles">Unhide</a>
						</span></h2>
						...
						<br /><a href="${pageContext.request.contextPath}/ArticleController?action=more&find=${articles.getAid()}">Read More</a></p>
